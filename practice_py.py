...
# 1.
Sadia is a school teacher who is trying to make learning fun for her students. She wants to create a program that generates random multiplication questions for her class to solve. She decides to keep generating questions until her students have answered ten correctly in a row.
"""

import random()
random

"""# 2.	Road traffic Violation Fine Calculator
Instructions:
...
"""# 4.	Admission Eligibility Checker
Instructions:
...
"""# A restaurant in Lahore wants to provide personalized menu suggestions to customers. Develop a Python program that takes a customer's dietary preference (vegetarian or non-vegetarian) as input and suggests menu items accordingly.
Details:
